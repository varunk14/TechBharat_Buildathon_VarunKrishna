...
// gemini-2.0-flash is deliberately chosen over the newer thinking models: it
// has no pre-output reasoning delay, so the first token arrives in well under a
// second, which is what keeps the whole flow inside the 3s budget. It still
// handles structured summaries and Indic scripts well and accepts image input
// for the vision mode later.
