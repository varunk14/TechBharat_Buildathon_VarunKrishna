...
// gemini-flash-latest is an alias for the current Flash model and, unlike
// gemini-2.0-flash, is actually granted on the free tier (gemini-2.0-flash
// returns a hard free-tier limit of 0 for many accounts). It is a reasoning
// model, so thinkingLevel is kept low below to hold latency down.
