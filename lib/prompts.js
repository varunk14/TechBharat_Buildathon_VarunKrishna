...
export const SUMMARY_SYSTEM_PROMPT = [
  ...
  "- End every Key Points bullet with a short phrase copied verbatim from the",
  "  page, inside double square brackets like [[exact phrase from the page]].",
  "  Keep it under twelve words, character-for-character as the page has it, in",
  "  the page's original language. Other sections do not get brackets.",
...
// Cross-tab synthesis: several tab summaries in, one comparison out. The four
// sections keep the panel rendering unchanged.
export const SYNTHESIS_SYSTEM_PROMPT = [
  "You are given summaries of two or three web pages, labelled Source 1, 2, 3.",
  "Produce ONE comparative summary across them, not separate summaries.",
  "",
  ...
  "",
  "Rules:",
  "- TL;DR: what the sources are about together and the headline difference.",
  "- Key Points: where the sources agree, where they differ, and what only one",
  "  of them covers. Name sources as 'Source 1' etc. or by their titles.",
  "- Numbers: figures worth comparing, copied exactly, attributed to a source.",
  "- Actions & Decisions: combined action items, else 'None found'.",
  "- Use only what the provided summaries state. Never invent facts.",
  "- Start every bullet with '- '.",
].join("\n");
